"""greeks_snapshot_mgr.py — IBKR 스냅샷 요청 관리  S12
...
class SnapshotManager:
    ...
    def record_received(self, rid: int):
        """tick 수신 시 tab_greeks에서 호출 → 카운터 증가 + 신호등 갱신."""
    ...
    def _start_0dte_streaming(self):
        ...
        for strike in self._strikes(self._und, wing, step):
            for side in ("C", "P"):
                ...
                con = self._make_con(self._sym, strike, side, self._exp_0, "0DTE")
