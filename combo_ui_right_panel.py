...
class RightPanelMixin:
    ...
    def _on_chase_click(self):
        ...
        from combo_order_chaser import on_chase_click
        on_chase_click(self)
...
from combo_ui_leg_logic import (
    ...
    _reset_legs, _set_leg_mode, _manual_add_leg, _manual_del_leg,
)
...
from combo_order_logic import _on_synthetic_order, _on_check_margin
RightPanelMixin._on_synthetic_order = _on_synthetic_order  # type: ignore[attr-defined]
