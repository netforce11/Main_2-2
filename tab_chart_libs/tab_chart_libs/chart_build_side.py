...
# [분리] _FoldableGroup → chart_foldable_group.py
from chart_foldable_group import _FoldableGroup  # noqa: F401
...
def build_sidebar(self) -> QScrollArea:
    ...
    from chart_build_side_bottom import _build_bottom_section
    return _build_bottom_section(self, side)
...
# [분리] _CustomCalendar → chart_calendar_widget.py
from chart_calendar_widget import _CustomCalendar  # noqa: F401