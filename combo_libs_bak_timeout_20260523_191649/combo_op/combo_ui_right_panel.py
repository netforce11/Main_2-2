...
# v2.3: Optimizer 팝업 방식 — combo_op 패키지에서 import
from combo_op.combo_op_dialog import _toggle_optimizer_panel  # noqa: F401
...
class RightPanelMixin:
    ...
    def _build_right_panel(self) -> QWidget:
        ...
        # v2.3: Optimizer 슬라이드 패널 제거 — 팝업 방식으로 전환
        # _toggle_optimizer_panel 클릭 시 OptimizerDialog 팝업이 열림
        return container
